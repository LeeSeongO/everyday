...
def solution(participant: List[str], completion: List[str]) -> str:
    ...
    for name in participant_sort:
        for i in range(len(completion_sort)):
            if name == completion_sort[i]:
                del completion_sort[i]
                break
        else:
            answer = name
